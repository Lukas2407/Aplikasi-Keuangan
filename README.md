# £ Catatan Keuangan — Pencatatan Bulanan untuk 2 Orang, 2 HP

Aplikasi HP (PWA) untuk mencatat keuangan bulanan **bersama**, dalam **poundsterling (£)**.
Setiap layar menampilkan **keuangan satu orang saja** supaya angkanya tidak tercampur, sementara
datanya **tersinkron real-time** antar HP — ketuk nama satunya di pengalih atas untuk melihat
...
- **👤 Tampilan per orang** — Beranda, Riwayat, dan Review hanya menampilkan satu orang; aplikasi terbuka pada pemilik HP itu, dan pengalih di atas untuk melihat pengguna satunya.
...
- **🔒 Kunci pribadi** — catatan tiap orang dilindungi PIN sendiri (di-hash SHA-256, berlaku di kedua HP). PIN yang dimasukkan menentukan catatan siapa yang terbuka; setelah masuk, catatan orang satunya hanya bisa **dilihat**, tidak bisa diubah. Kunci otomatis setelah 5 menit menganggur.
